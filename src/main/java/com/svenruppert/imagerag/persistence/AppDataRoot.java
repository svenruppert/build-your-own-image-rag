...
public class AppDataRoot {
  ...
  /**
   * Taxonomy improvement suggestions generated by TaxonomyAnalysisService.
  ...
  /**
   * Cluster-based category-discovery suggestions generated by ClusterDiscoveryService.
   * Suggestions require explicit user review before conversion to TaxonomySuggestion.
   * Not declared final for EclipseStore Unsafe reconstruction compatibility.
   */
  private List<CategoryClusterSuggestion> clusterSuggestions;

  /**
   * Versioned prompt templates managed by PromptTemplateService.
   * At most one version per promptKey is active at any time.
   * Not declared final for EclipseStore Unsafe reconstruction compatibility.
   */
  private List<PromptTemplateVersion> promptVersions;
  ...
  /**
   * Returns the cluster-suggestion list, lazily initialising it if null.
   */
  public List<CategoryClusterSuggestion> getClusterSuggestions() {
    if (clusterSuggestions == null) {
      clusterSuggestions = new ArrayList<>();
    }
    return clusterSuggestions;
  }

  /**
   * Returns the prompt-version list, lazily initialising it if null.
   */
  public List<PromptTemplateVersion> getPromptVersions() {
